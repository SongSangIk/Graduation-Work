...
glassess_detector = cv2.CascadeClassifier('C:/Users/thdtn/Desktop/Graduation-Work-main/Graduation-Work-main/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
...
print("\n [INFO] 사용자 {0}의 학습이 완료되었습니다. 잠시만 기다려주세요.".format(len(np.unique(ids))))
#----------------------------------------------------------------------------------------------------------- 인식
recognizer = cv2.face.LBPHFaceRecognizer_create()
...
while True:
    ...
    eyes = glassess_detector.detectMultiScale(
            gray,
            scaleFactor= 1.5,
            minNeighbors=10,
            minSize=(5, 5),
